...
int main(int argc, char *argv[])
{
	...
	unsigned char ro_buff[SHMSZ]; // Readonly tampon: wiringPiSPIDataRW SPI input'unu buff'a geri yaziyor.
	char *shm, *s;
	clock_t start, end;
	int i, f_c=0, f_c2=0, data_changed, shm_read_count = PORT_COUNT / 8;
	
	// SHGM SHM segmenti okunuyor pointer'ı ile ilişkilendiriliyo	
